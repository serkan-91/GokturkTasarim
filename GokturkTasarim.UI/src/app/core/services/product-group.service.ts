...
export class ProductGroupService {
  ...
  private mockProducts: ProductDto[] = [
    { id: '10000000-0000-0000-0000-000000000001', productCode: 'PJ-7600-16GB', name: 'Usb Bellek 16 GB', slug: 'usb-bellek-16gb', category: 'USB Bellekler', externalCategoryId: 'cat-usb', basePrice: 180, unit: 'adet', stockQuantity: 500, inStock: true, imageUrl: 'https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?auto=format&fit=crop&w=600&q=80', description: 'Metal döner kapaklı 16 GB USB bellek, logo baskısına uygundur.' },
    { id: '10000000-0000-0000-0000-000000000002', productCode: 'PJ-5600-32GB', name: 'Usb Bellek 32 GB', slug: 'usb-bellek-32gb', category: 'USB Bellekler', externalCategoryId: 'cat-usb', basePrice: 240, unit: 'adet', stockQuantity: 400, inStock: true, imageUrl: 'https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?auto=format&fit=crop&w=600&q=80', description: 'Yüksek hızlı 32 GB USB bellek, kurumsal hediyelik.' },
    { id: '10000000-0000-0000-0000-000000000003', productCode: 'PJ-7770-32GB', name: 'Işıklı Usb Bellek 32 GB', slug: 'isikli-usb-32gb', category: 'USB Bellekler', externalCategoryId: 'cat-usb', basePrice: 290, unit: 'adet', stockQuantity: 300, inStock: true, imageUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=600&q=80', description: 'Lazer kazıma sonrası LED ışıklı logo aydınlatmalı USB bellek.' },
    { id: '10000000-0000-0000-0000-000000000004', productCode: 'PJ-5200-32GB', name: 'Metal Usb Bellek 32 GB', slug: 'metal-usb-32gb', category: 'USB Bellekler', externalCategoryId: 'cat-usb', basePrice: 310, unit: 'adet', stockQuantity: 250, inStock: true, imageUrl: 'https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?auto=format&fit=crop&w=600&q=80', description: 'Şık metal gövdeli, anahtarlıklı 32 GB hediye USB bellek.' },
    ...
    { id: '10000000-0000-0000-0000-000000000010', productCode: 'GKT-PR-01', name: 'Promosyon Logo Baskılı Metal Kalem', slug: 'promosyon-kalem', category: 'Kurumsal Promosyon', externalCategoryId: 'sub-kalem-set', basePrice: 35, unit: '100 adet', stockQuantity: 5000, inStock: true, imageUrl: 'https://images.unsplash.com/photo-1585336261026-8f5786372969?auto=format&fit=crop&w=600&q=80', description: 'Kurumsal logonuza özel tampon baskılı metal tükenmez kalem.' },
